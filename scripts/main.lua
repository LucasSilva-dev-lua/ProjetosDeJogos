...
chao.id = "chao"
-- parâmetros para criar a boc {x ref imagem=, y ref a imagem=, metade da largura box=, metade da altura box=, angulo da box= }
physics.addBody (chao, "static", {friction = 1, box = {x=0, y=0, halfWidth=480, galfHeight=40, angle=0}})
