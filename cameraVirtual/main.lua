...
camera:prependLayer () -- Prepara os layers de camera.

display.setStatusBar (display.HiddenStatusBar)

local bg = display.newImageRect ("imagens/bg.jpg", 500, 360)
...
camera.damping = 10 -- Controla a fluidez da câmera ao seguir o player.
